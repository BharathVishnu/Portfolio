...
export default function Homepage({ projects, skills, contact }: HomepageProps) {
  ...
  return (
    <main className="bg-black text-white min-h-screen overflow-hidden md:cursor-none selection:bg-cyan-400 selection:text-black">
      <CustomCursor />
      <ParticleBackground />
      <FloatingGradient />
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center w-full max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.div
              ...
              className="relative w-[300px] h-[420px] md:w-[340px] md:h-[480px] rounded-[40px] overflow-hidden border border-zinc-800 shadow-2xl"
            >
              <img
      ...
      <section className="relative z-10 px-6 md:px-20 py-20">
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-6">
          {[
            ...
            { icon: Server, title: "Backend", text: "Spring Boot, Node.js, FastAPI" },
            { icon: Database, title: "Database", text: "PostgreSQL, Redis, Firebase" },
          ].map((item) => {
            ...
            return (
              <motion.div
                key={item.title}
                whileHover={{ y: -8 }}
                className="border border-zinc-800 rounded-[30px] p-8 bg-zinc-900/40 backdrop-blur-xl"
              >
        ...
        <div className="max-w-6xl mx-auto flex flex-wrap justify-center gap-5">
          {skills.map((skill, index) => (
            <motion.button
              ...
              className="px-6 py-4 rounded-2xl border transition-all duration-300 bg-zinc-900/40 border-zinc-800 text-zinc-300 hover:bg-cyan-400 hover:text-black hover:border-cyan-400"
            >
              {skill}
            </motion.button>
          ))}
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                <div className="h-56 rounded-3xl bg-gradient-to-br from-zinc-800 to-zinc-900 border border-zinc-700 mb-8 overflow-hidden relative">
                  <motion.div
      ...
      <section className="relative z-10 px-6 md:px-20 py-32">
        <motion.div
          ...
          viewport={{ once: true }}
          className="max-w-5xl mx-auto text-center border border-zinc-800 rounded-[40px] p-10 md:p-16 bg-zinc-900/40 backdrop-blur-2xl"
        >
